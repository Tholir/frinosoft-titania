...
export interface Race {
  ...
  speed: number;
  abilityScoreIncrease: Array<{ ability: AbilityName; bonus: number }>;
...
export interface ClassFeature {
  ...
  prerequisites?: { feature: string; level?: number }[];
}
...
export interface Character {
  ...
  currency: Currency;
  features: Array<{ name: string; source: string; description: string; usesPerRest?: string }>;
